...
class Mysql(object):
    ...
    def _exeCute(self, sql=''):
        try:
            ...
            error = 'MySQL execute failed! ERROR %s' % e
            print(error)
    ...
    def _insertMany(self, table, attrs, values):
        ...
        try:
            ...
            self._conn.rollback()
            error = '_insertMany executemany failed! ERROR %s' % e
            print(error)
...
if __name__ == '__main__':
    ...
    insert_sql = """
            insert into tb_ys_user_file_info(user_name, file_name, file_type, file_size, file_url, upload_date, create_time)
            VALUES (%s, %s, %s, %s, %s, %s, %s)
    """
    id = mysql.insertOne(insert_sql, (1, 1, 1, 1, 1, '2019-01-01', dt))
    print(id)
